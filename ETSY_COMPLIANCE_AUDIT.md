...
**Current status (2026-07-16):** All findings below marked FIXED are live in production (merged `435a1aa` and subsequent, deployed 2026-07-14). Backend test suite: 982 passed (current authoritative count — see `PROJECT_STATUS.md`; older counts inline below are historical checkpoints, each explicitly superseded). Retention cleanup automated (DO Scheduled Job; second consecutive successful run 2026-07-16, following the first on 2026-07-15 — see `ETSY_DATA_RETENTION.md` §2). Etsy app remains **Banned**, no reason given; **the appeal has been submitted by the owner** (see `ETSY_FINAL_APPEAL_DRAFT.md` submission-status header) and the project is awaiting Etsy's response.

**Post-submission public-website mismatch, found and corrected (2026-07-16, PR #64):** after the appeal was submitted, a fresh forbidden-term audit of the live public site found that the 2026-07-14 fix (below) had not caught every instance of public AI wording — the homepage hero, pricing preview/plan highlight, `/features` metadata and safety line, FAQ, and the feature-page registry still referenced "AI optimization"/"AI credits"/"AI Listing Optimization" in a few places. All were neutralized, Privacy/Terms were updated to describe the current AI-safeguard and retention/account-deletion behavior, and the corrected site was deployed and re-verified live. No authenticated in-app AI or Listing Health functionality was touched — see `CHANGELOG.md` [2026-07-16] for the itemized list.
