...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(as_uuid=False), primary_key=True),
        sa.Column("organization_id", sa.Uuid(as_uuid=False), sa.ForeignKey("organizations.id", ondelete="CASCADE"), nullable=False, index=True),
        sa.Column("ai_session_id", sa.Uuid(as_uuid=False), sa.ForeignKey("ai_sessions.id", ondelete="CASCADE"), nullable=False, index=True),
        sa.Column("listing_id", sa.Uuid(as_uuid=False), sa.ForeignKey("listings.id", ondelete="SET NULL"), nullable=True, index=True),
        ...
        sa.Column("converted_to_session_id", sa.Uuid(as_uuid=False), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.func.now()),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.func.now()),
    )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(as_uuid=False), primary_key=True),
        sa.Column("organization_id", sa.Uuid(as_uuid=False), sa.ForeignKey("organizations.id", ondelete="CASCADE"), nullable=False, index=True),
        sa.Column("ai_session_id", sa.Uuid(as_uuid=False), sa.ForeignKey("ai_sessions.id", ondelete="SET NULL"), nullable=True, index=True),
