import uuid
from sqlalchemy import Text, JSON, ForeignKey, Uuid, String, UniqueConstraint
...
class BulkEditPreviewItem(Base, TimestampMixin):
    ...
    listing_id: Mapped[str] = mapped_column(Uuid(as_uuid=False), ForeignKey("listings.id", ondelete="CASCADE"), nullable=False)
