import uuid
from sqlalchemy import String, Integer, JSON, ForeignKey, Text, Uuid
...
class CSVRow(Base, TimestampMixin):
    ...
    csv_job_id: Mapped[str] = mapped_column(Uuid(as_uuid=False), ForeignKey("csv_jobs.id", ondelete="CASCADE"), nullable=False, index=True)
