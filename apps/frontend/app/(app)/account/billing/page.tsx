...
function BillingContent() {
  ...
  if (loading) {
    return <p className="text-gray-500 text-sm">Loading billing…</p>;
  }

  const hasPaidPlan = sub != null && sub.effective_plan !== "free";
  ...
  return (
    <div className="space-y-6">
      ...
      {canceled && (
        <div className="rounded-lg bg-yellow-50 border border-yellow-200 text-yellow-700 px-4 py-3 text-sm">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm divide-y divide-gray-100">
          <div className="p-6">
            ...
            <p className="text-xs text-gray-500 mt-2">
              {sub.billing_charge_status === "charged" ? "Billed through Stripe." : "Not billed through Stripe."}
            </p>
          ...
          <div className="p-6 flex flex-col sm:flex-row gap-3">
            {hasPaidCustomer ? (
              ...
              <div className="flex-1 rounded-lg bg-gray-50 border border-gray-200 text-gray-500 text-sm text-center py-2.5">
                No Stripe subscription is associated with this plan.
              </div>
            ) : (
              <div className="flex-1 rounded-lg bg-gray-50 border border-gray-200 text-gray-500 text-sm text-center py-2.5">
...
export default function AccountBillingPage() {
  return (
    <Suspense fallback={<p className="text-gray-500 text-sm">Loading billing…</p>}>
      <BillingContent />
    </Suspense>
  );
}
