...
Before doing any project work, read `.hiveai/RULES.md`, `.hiveai/PROJECT.json`, `.hiveai/STATE.json`, `.hiveai/HANDOFF.md`, and the canonical task source declared in PROJECT.json.
